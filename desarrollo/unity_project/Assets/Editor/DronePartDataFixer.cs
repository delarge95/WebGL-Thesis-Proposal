...
namespace WebGL.Editor
{
    public class DronePartDataFixer : EditorWindow
    {
        ...
        public static void FixCategories()
        {
            ...
            foreach (string guid in guids)
            {
                ...
                if (data != null)
                {
                    ...
                    // Aseguramos que solo los nodos "padre" canónicos tengan HotspotTarget activado para UI Macro.
            ...
            Debug.Log($"[DronePartDataFixer] ¡Éxito! {fixedCount} activos actualizados según la taxonomía 6-tiers.");
        }
        ...
        private static string[] GetKnownSubcomponents(string id)
        {
            ...
            if (id.Contains("x500v2_motor_")) return new[] { "Holybro 2216 KV880 Motor Unit", "Propeller Mount Set", "Mount Base Plate" };
