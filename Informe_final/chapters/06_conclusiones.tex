...
\begin{itemize}
    ...
    \item las sesiones con usuarios se realizaron en dispositivos controlados y sobre la misma build asociada al commit final \texttt{4bdc153}; el commit \texttt{5eebc81} se conserva como referencia intermedia de vinculación documental. La caché del navegador se cargó previamente, lo que mejora la trazabilidad de la medición pero limita la generalización a otros equipos;
