...
classes = (CAD_Properties,CAD_OT_auto_detect,CAD_OT_set_origins_backup,CAD_OT_scan_math_kabsch,CAD_OT_create_instances,CAD_OT_apply_rots_kabsch,CAD_OT_revert_undo,CAD_PT_panel_v5)
def register():
