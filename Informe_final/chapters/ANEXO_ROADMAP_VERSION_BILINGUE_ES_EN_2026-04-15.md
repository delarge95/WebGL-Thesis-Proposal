...
- Politica uniforme para datos no aplicables: N/A.
...
- UI textual: etiquetas, variables de texto, botones, mensajes de estado, tooltips.
...
- Implementar I18nService con responsabilidades:
  ...
  - Formateo con marcadores tipados.
...
- Riesgo: desalineacion entre textos de datos y UI.
  - Mitigacion: pruebas de snapshot y validacion de marcadores tipados.
...
- Formateo de marcadores por idioma.
...
- Reporte de cobertura de claves y claves no cubiertas.
