...
namespace WebGL.Core.Managers
{
    ...
    public class CrossSectionManager : Singleton<CrossSectionManager>
    {
        ...
        private Vector3 lastAppliedWorldCenter;
        private bool hasAppliedWorldCenter;
        ...
        private void LateUpdate()
        {
            ...
            Vector3 worldCenter = ResolveWorldCenter();
            if (!hasAppliedWorldCenter || (worldCenter - lastAppliedWorldCenter).sqrMagnitude > 0.000001f)
            {
                UpdateAndApply(worldCenter);
            }
        }
        ...
        {
            UpdateAndApply(ResolveWorldCenter());
        }

        private void UpdateAndApply(Vector3 worldCenter)
        {
            lastAppliedWorldCenter = worldCenter;
            hasAppliedWorldCenter = true;
        ...
        private Vector3 ResolveWorldCenter()
        {
            return targetObject != null ? targetObject.position : Vector3.zero;
        }
