...
Use [KIMI_PROMPT.md](./KIMI_PROMPT.md) as the current prompt. It intentionally avoids outdated claims such as public "7 view modes", measurement tools, BOM, connection points or closed performance results.
...
- Do not report FPS, reduction percentages, load times or usability values until the build is frozen and measured.
...
| 11 | Technical State | Dashboard | Measured fields as pending placeholders |
...
| 17 | Results To Close | Checklist | Freeze-dependent evidence |
...
- [ ] Metrics placeholders replaced only if measured on frozen build.
...
*Package Version: 3.0*
*Updated: 2026-05-08*
*Project: WebGL Drone Viewer Thesis*
