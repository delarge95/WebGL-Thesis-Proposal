...
\textbf{2. Equipos y Software} & Hardware: PC con GPU Dedicada (existente). Software: Unity 6 (Licencia Estudiante), Blender 4.0 (Open Source), VS Code (Gratuito), Adobe Substance Painter (Licencia Estudiante), Git LFS / Spector.js (Open Source). Hosting/Dominio ($\sim$150,000). & 150,000 \\ 
