...
Este documento define los recursos visuales para la defensa usando la realidad actual de la app. Reemplaza requisitos antiguos que pedian siete miniaturas de modos visibles, herramientas de medicion/BOM o stat cards con metricas no medidas.
...
| 16 Validation | Empty metrics framework | Use placeholders, not fake values |
| 17 Results | Pending dashboard | Values only after freeze |
...
Allowed labels before freeze:

- `FPS promedio: pendiente post-freeze`
- `Frame time: pendiente post-freeze`
- `Peso final assets: pendiente post-freeze`
- `SUS: pendiente post-prueba`
- `NASA-TLX Raw: pendiente post-prueba`
...
- [ ] No measured values invented before freeze.
