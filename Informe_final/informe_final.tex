...
\input{../Propuesta/sections/planteamiento_problema}
\input{../Propuesta/sections/justificacion}
\input{../Propuesta/sections/objetivos}
\section{Marco de Referencia}
\input{../Propuesta/sections/estado_del_arte}
\input{../Propuesta/sections/marco_teorico}
\input{../Propuesta/sections/marco_conceptual}
\input{../Propuesta/sections/metodologia}

% --- NUEVAS SECCIONES DEL INFORME FINAL ---

\newpage
\section{Desarrollo e Implementación}
El desarrollo del prototipo siguió una metodología iterativa en fases (DSR Sprints), resultando en 91 scripts con aproximadamente 14,778 líneas de código C\#, 9 shaders personalizados (~1,749 líneas HLSL/CG) y un design system basado en UI Toolkit (5 USS + 4 UXML). La implementación abarca sistemas de interacción, visualización, audio, y herramientas especializadas para ingenieros.
...
\begin{itemize}
    ...
    \item \textbf{Service Locator (H01):} Resolución de dependencias en runtime
    \item \textbf{Event Bus (Pub/Sub):} Comunicación desacoplada con detección de leaks y purga de zombies (H03)
    \item \textbf{Strategy (BaseModeHandler, H02):} 3 handlers concretos para modos Inspect/Analyze/Studio
    \item \textbf{State Machine:} Control de estados de la aplicación (9 estados con transiciones validadas)
...
\newpage
\input{../Propuesta/sections/bibliografia}
