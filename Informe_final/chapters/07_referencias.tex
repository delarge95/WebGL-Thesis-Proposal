...
\item Brooke, J. (1986). SUS: A ``quick and dirty'' usability scale. En P. W. Jordan, B. Thomas, I. L. McClelland, \& B. Weerdmeester (Eds.), \textit{Usability evaluation in industry} (pp. 189--194). Taylor \& Francis.
...
\item Unity Technologies. (2024). \textit{UI Toolkit}. Unity Documentation. \url{https://docs.unity3d.com/Manual/UIElements.html}

\item Unity Technologies. (2024). \textit{Universal Render Pipeline overview}. Unity Documentation. \url{https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@17.0/manual/}
